...
from app.services.rpc import weather_pb2 as weather__pb2
...
if _version_not_supported:
    raise RuntimeError(
        f'The services package installed is at version {GRPC_VERSION},'
        + ' but the generated code in weather_pb2_grpc.py depends on'
        + f' grpcio>={GRPC_GENERATED_VERSION}.'
        + f' Please upgrade your services module to grpcio>={GRPC_GENERATED_VERSION}'
...
class WeatherServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetWeatherHistory = channel.unary_unary(
                '/weather.WeatherService/GetWeatherHistory',
                request_serializer=weather__pb2.WeatherHistoryRequest.SerializeToString,
                response_deserializer=weather__pb2.WeatherHistoryResponse.FromString,
                _registered_method=True)
...
def add_WeatherServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetWeatherHistory': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=weather__pb2.WeatherHistoryRequest.FromString,
                    response_serializer=weather__pb2.WeatherHistoryResponse.SerializeToString,
            ),
    }
...
class WeatherService(object):
    ...
    def GetWeatherHistory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/weather.WeatherService/GetWeatherHistory',
            weather__pb2.WeatherHistoryRequest.SerializeToString,
            weather__pb2.WeatherHistoryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
